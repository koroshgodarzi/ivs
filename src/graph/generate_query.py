from graph.utils import get_llm, extract_json_from_text, create_column_names_for_schemas
...
def get_system_prompt(schema_list: list, needed_categories: str) -> str:
    ...
    # Ensure needed_categories is processed correctly
    all_schemas_metadata = create_column_names_for_schemas(schema_list, needed_categories)

    # Format the base template with the aggregated list of all columns from all schemas
