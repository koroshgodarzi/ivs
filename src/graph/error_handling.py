...
from graph.utils import get_llm, create_column_names_for_schemas, extract_json_from_text
...
def explain_query_error(state: GraphState) -> GraphState:
    """
    ...
    response = extract_json_from_text(response.content.strip())
