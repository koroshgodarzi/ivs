...
DATA_DIR = os.path.join(BASE_DIR, 'data', 'clean_ID_excluded')
DOCS_DIR = os.path.join(BASE_DIR, 'data', 'clean_ID_excluded')
...
def main():
    output = {}
    output_folder = 'viewSelectionWithLLMAndColumnTogetherIDExcludedJoinPromptStricter'
    follow_up = False
